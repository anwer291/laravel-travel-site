        ...
        <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                            <div class="service-content text-end">
                                ...
                                <p class="mb-0">
                                    Explore the world with ease. Our international tour packages are designed for solo travelers, families, and couples. Discover famous cities and hidden gems with comfort, safety, and expert planning.
                                </p>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                            <div class="service-content text-end">
                                ...
                                <p class="mb-0">
                                    Book your stay with confidence. We offer top hotel deals worldwide, from luxury resorts to budget-friendly hotels. Experience comfort, convenience, and value — all without booking fees or stress.
                                </p>
                            </div>
                            <div class="service-icon p-4">
                    ...
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                            <div class="service-content text-end">
                                ...
                                <p class="mb-0">
                                    Our experienced travel guides help you discover local culture, food, and sights. With insider tips and expert support, you can explore every destination in depth and enjoy a truly authentic journey.
                                </p>
                            </div>
                            <div class="service-icon p-4">
                    ...
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                            <div class="service-content text-end">
                                ...
                                <p class="mb-0">
                                    Let us manage your events from start to finish — destination weddings, corporate tours, and more. We ensure smooth coordination, perfect venues, and professional arrangements tailored to your needs for a stress-free event.
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                            ...
                            <div class="service-content">
                                <h5 class="mb-4">✈️ Cheap Flights</h5>
                                <p class="mb-0">
                                    Fly smart with our flight deals from the UK to global destinations. We compare airlines to bring you the best fares, ideal travel times, and top service — all in one place.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                            ...
                            <div class="service-content">
                                <h5 class="mb-4">🌴 Cheap Holidays</h5>
                                <p class="mb-0">
                                    Plan your perfect holiday without breaking the bank. Our custom holiday packages include flights, hotels, and activities, all tailored to your budget and interests. Relax and enjoy every moment.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                            ...
                            <div class="service-content">
                                <h5 class="mb-4">🚘 Car Hire</h5>
                                <p class="mb-0">
                                    Rent a car with ease across the UK and worldwide. Choose from economy to luxury vehicles and book instantly online. Reliable service and competitive prices, wherever your travels take you.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                            ...
                            <div class="service-content">
                                <h5 class="mb-4">🛡️ Travel Insurance</h5>
                                <p class="mb-0">
                                    Stay protected on every journey. Our travel insurance covers medical emergencies, trip cancellations, baggage loss, and more. Choose from top providers to keep yourself and your trip secure, safe, and worry-free at all times.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="text-center">
                    <a class="btn btn-primary rounded-pill py-3 px-5 mt-2" href="">See All Services</a>
                </div>
            </div>
        </div>
    </div>
